...
<?php
   ...
   $subject = 'Poruka s detailing Interijeri > aromatizacija interijera ';
	...
	<br/>
        ...
        <div>
          <table style="width: 400px;" border="1">
              ...
              <tr>
                  <th colspan="2"><h3>Obrazac s  aromatizacija interijera </h3></th>
              </tr>
...
<head><meta charset="utf-8">
  ...
  <meta name="keywords" content="aromatizacija auta, obrada ozonom, antibakterijska obrada, čišćenje ventilacije, nano zaštita, auto detailing, detailing, njega vozila, zaštita vozila, kemijsko čišćenje, pranje auta" />
  <meta name="description" content="Aromatizacija interijera auta, uništavanje loših mirisa ozonom, antibakterijska obrada klime i ventilacije vašeg vozila.  Poliranje, nano premazi, priprema auta za prodaju…">
  <meta name="robots" content="all ">
  <title>Detailing Star | Profesionalna Njega Vozila | Aromatizacija interijera auta</title>
  ...
  <div id="wrapper">
	...
	<div id="callback-form-container">
        ...
        <div id="callback-popup">
        	...
        	<a href="" class="close-callback-popup">&times;</a>
	...
	<div class="callback">
          	...
          	<a href="" class="open_callback_form">Webshop</a>

         </div>

	  <div class="contact-item">

		<span class="phone">01 4852 449</span>
...
</ul><div class="mobile-nav-close mobile-only"></div></nav>

<nav class="b-header-mobile-menu" style="display:none"><div class="mobile-menu"><a href="../Kontakt/kontakt.php" title="Kontakt">

            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"viewBox="0 0 20 20" enable-background="new 0 0 20 20" xml:space="preserve"><g><path fill="#141515" d="M10,10.953c-2.239,0-4.061-1.821-4.061-4.06S7.761,2.833,10,2.833s4.061,1.821,4.061,4.06 S12.239,10.953,10,10.953z M10,4.233c-1.467,0-2.66,1.193-2.66,2.66s1.193,2.66,2.66,2.66s2.66-1.193,2.66-2.66	S11.467,4.233,10,4.233z"/><path fill="#141515" d="M10,19.801l-0.545-0.675c-2.669-3.306-6.218-8.17-6.218-12.233C3.237,3.164,6.271,0.13,10,0.13	s6.763,3.034,6.763,6.763c0,4.069-3.549,8.93-6.218,12.234L10,19.801z M10,1.531c-2.957,0-5.362,2.405-5.362,5.362 c0,3.366,2.915,7.574,5.362,10.672c2.448-3.096,5.362-7.302,5.362-10.672C15.362,3.936,12.957,1.531,10,1.531z"/></g></svg></a>



<a href="tel:+1 4852 449" title="Telefon"><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 20 20" enable-background="new 0 0 20 20" xml:space="preserve"><g><path fill="#141515" d="M14.746,19.933c-3.122,0-6.896-2.61-9.481-5.197c-3.101-3.1-6.235-7.908-4.866-11.252l0.053-0.13 L3.732,0.07l5.569,5.57l-2.373,2.37c0.907,1.958,3.104,4.155,5.062,5.062l2.37-2.37l5.57,5.566l-3.283,3.281l-0.13,0.053 C15.963,19.829,15.367,19.933,14.746,19.933z M1.646,4.137c-0.767,2.187,1.105,6.106,4.607,9.609 c3.503,3.503,7.425,5.372,9.609,4.607l2.087-2.086l-3.59-3.587l-2.03,2.031l-0.423-0.158c-2.591-0.972-5.489-3.87-6.461-6.462 L5.288,7.669l2.033-2.031L3.732,2.05L1.646,4.137z"/></g></svg></a>



<a href="" title="webshop"><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 20 20" enable-background="new 0 0 20 20" xml:space="preserve"><g><polygon fill="#141515" points="17.502,15.164 5.871,15.164 2.39,2.175 0.285,2.175 0.285,0.774 3.464,0.774 6.945,13.764 17.502,13.764"/><path fill="#141515" d="M17.503,12.552H7.852L5.478,3.687h14.399L17.503,12.552z M8.926,11.151h7.503l1.624-6.064H7.302 L8.926,11.151z"/><path fill="#141515" d="M7.885,19.226c-0.919,0-1.666-0.746-1.666-1.663s0.747-1.664,1.666-1.664c0.917,0,1.664,0.747,1.664,1.664 S8.802,19.226,7.885,19.226z M7.885,17.299c-0.146,0-0.266,0.118-0.266,0.264c-0.001,0.287,0.528,0.29,0.529,0 C8.148,17.417,8.03,17.299,7.885,17.299z"/><path fill="#141515" d="M16.004,19.226c-0.917,0-1.664-0.746-1.664-1.663s0.747-1.664,1.664-1.664s1.663,0.747,1.663,1.664 S16.921,19.226,16.004,19.226z M16.004,17.299c-0.146,0-0.264,0.118-0.264,0.264c0,0.286,0.526,0.287,0.526,0 C16.267,17.417,16.148,17.299,16.004,17.299z"/></g></svg></a>



<a title="Meni" class="mobile-menu-toggle">

<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 20 20" enable-background="new 0 0 20 20" xml:space="preserve"><g><rect y="2.305" width="20" height="1.4"/><rect y="9.3" width="20" height="1.4"/><rect y="16.295" width="20" height="1.4"/></g></svg>
...
<div class="popup js__popup js__slide_top">
  ...
  <li itemscope="itemscope" class="B_crumb" itemtype="http://data-vocabulary.org/Breadcrumb">
    ...
    <li itemscope="itemscope" class="B_lastCrumb B_crumb" itemtype="http://data-vocabulary.org/Breadcrumb" >
      <a class="B_crumb" itemprop="url" rel="Салон" href="/services/salon/"><span itemprop="title">Aromatizacija interijera auta</span></a>
  </li>
...
<div class="wrap-h1">
 <div class="inner">
        <h1>
          <span>Aromatizacija interijera auta</span>
        </h1>
 </div>
</div>
...
<?php echo "<h1 class='errorForm'>$warning</h1>"; ?>
          ...
          <article style="display: none;">
			<p style="text-align: center;"><img src="../assets/template/images/leather.jpg" alt="" width="560" height="373" /></p>
<p>Для борьбы с повреждениями, возникающими на коже и кожзаменителе, существует современная технология <strong><span style="color: #7030a0;">Advance Leather</span></strong>, позволяющая устранять появляющиеся в процессе эксплуатации повреждения.<br /><br />Технология <strong><span style="color: #7030a0;">Advance Leather</span></strong>, в отличие от многих других систем ремонта и окраски кожи, лишь на время маскирующих дефект, позволяет без следа устранить практически любое повреждение. <br /><br />Все работы производятся с использованием материалов высочайшего качества, с соблюдением технологии заводской окраски, что позволяет без ущерба эксплуатировать салон на протяжении всего срока владения автомобилем.<br /><br /><strong>Преимущества технологии <span style="color: #7030a0;">Advance Leather</span>:</strong></p>
<ul>
<li><span style="line-height: 1.5em;">избавляет от царапин, разрывов, потертостей краски;</span></li>
<li><span style="line-height: 1.5em;">место ремонта не боится дальнейших механических воздействий и агрессивных химических очистителей;</span></li>
<li><span style="line-height: 1.5em;">салон сохраняет презентабельный вид;</span></li>
<li><span style="line-height: 1.5em;">гарантия на весь срок эксплуатации.<br /></span></li>
</ul>
<h3>Стоимость ремонта и восстановления кожи по технологии Advance Leather</h3>
<table class="pricelist-tbl">
<thead>
<tr><th>Ремонт и восстановление кожи Advance Leather</th><th>C класс</th><th>E класс</th><th>S класс и внедорожники</th></tr>
</thead>
<tbody>
<tr>
<td style="text-align: center;">Стоимость ремонта</td>
<td>от 3 000 руб.</td>
<td>от 3 000 руб.</td>
<td>от 3 000 руб.</td>
</tr>
...
<div class="contact-form order-form">
    ...
    <form action="aromatizacija-interijera-auta.php" method="post" id="zakazForm" role="form">
...
<!--div class="form-new">
		...
		<span class="form-zag"><span>Записаться на услугу - <i>Восстановительная полировка кузова</i></span></span>
		...
		<div class="msg_wrap">
	      ...
	      <div id="myform-wrap">  
           ...
           <form class="lightform" action="">

               <div class="inps">

			<label for="name" style="margin: 6px 24px 0 160px;">Ваше имя:*</label>

           <input class="inp" name="name" id="name" type="text" required />

		   <div class="clear marclear"></div>



		   <label style="margin: 6px 24px 0 170px;" for="phone">Телефон:*</label>

           <input class="inp" name="phone" id="phone" type="tel" pattern="[\d+-]{5,}" />

		   <div class="clear marclear"></div>



		   <label style="margin: 6px 31px 0 190px;" for="email">E-mail:</label>

           <input class="inp" name="email" id="email" type="email"/>

		   <div class="clear marclear"></div>



            <input type="hidden" name="type" value="raschet" />



            <input type="hidden" name="pagetitle" value="Восстановительная полировка кузова" />

 

 			<input type="hidden" name="url" value="http://www.advancestar.ru/services/kuzov/abrazivnaya-polirovka/" />
		   ...
		   <label style="margin: 6px 31px 0 130px;" for="comment">Комментарий:</label>

           <textarea class="inp" name="comment" id="comment" rows="10" ></textarea>

		   <div class="clear"></div>

		   <p class="att">*Обязательное поле для заполнения</p>
...
<!--div class="mob-frm">
	...
	<span class="form-zag-m"><span>Заказать услугу -<br /> <i>Восстановительная полировка кузова</i></span></span>

	<span class="phn">+7 495 991-39-69</span>
...
<div class="mob-frm" style="display: none;">
