...
<?php
   ...
   $subject = 'Poruka s detailing Interijeri > kemijsko čišćenje ';
	...
	<br/>
        ...
        <div>
          <table style="width: 400px;" border="1">
              ...
              <tr>
                  <th colspan="2"><h3>Obrazac s  kemijsko čišćenje </h3></th>
              </tr>
   ...
   <html class='ie ie8 lt-ie8' lang='en'>
      ...
      <html class='ie ie9' lang='en'>
         ...
         <head>
            ...
            <meta name="keywords" content="kemijsko čišćenje, autopraonica, nano zaštita, auto detailing, detailing, njega vozila, zaštita vozila, poliranje vozila, poliranje auta, pranje auta, čišćenje felga" />

            <meta name="description" content="Kompletno kemijsko čišćenje unutrašnjosti automobila. Poliranje, nano premazi, čišćenje motora, čišćenje i zaštita felgi, priprema auta za prodaju…">

            <meta name="robots" content="all ">

            <title>Detailing Star | Profesionalna Njega Vozila | Kemijsko čišćenje interijera</title>
            ...
            <script src="../assets/template/js/css3-mediaqueries.js"></script>  <![endif]--><!--[if lt IE 9]>  
       <script src="../assets/template/js/ie9.js"></script>  
        <![endif]-->  <script src="//code.jquery.com/jquery-1.9.1.min.js"></script>  
            ...
            <script type="text/javascript">    var site_base_url = '/';    
                     ...
                     <div class="content">
                        ...
                        <div class="wrap-h1">
                           ...
                           <div class="inner">
                              ...
                              <h1>          <span>Kemijsko čiščenje interjera</span>        </h1>
...
<?php echo "<h1 class='errorForm'>$warning</h1>"; ?>
                        ...
                        <article style="display: none;">
                           ...
                           <div class="contact-form order-form">
                              ...
                              <form action="kemijsko-ciscenje-interjera.php" method="post" id="zakazForm" role="form">
