...
<?php 
   ...
   $subject = 'Poruka s detailing Interijeri > antibakterijska  obrada ';
	...
	<br/>
        ...
        <div>
          <table style="width: 400px;" border="1">
              ...
              <tr>
                  <th colspan="2"><h3>Obrazac s antibakterijska obrada </h3></th>
              </tr>
   ...
   <html class='ie ie8 lt-ie8' lang='en'>
      ...
      <html class='ie ie9' lang='en'>
         ...
         <head>
            ...
            <meta name="keywords" content="antibakterijska obrada, čišćenje ventilacije, čišćenje, nano zaštita, auto detailing, detailing, njega vozila, zaštita vozila, kemijsko čišćenje, poliranje, pranje auta, felge" />

            <meta name="description" content="Antibakterijska obrada klime i ventilacije vašeg vozila.  Poliranje, nano premazi, čišćenje motora, čišćenje i zaštita felgi, priprema auta za prodaju…">

            <meta name="robots" content="all ">

            <title>Detailing Star | Profesionalna Njega Vozila | Antibakterijska obrada klime</title>
            ...
            <div id="wrapper">
               ...
               <div class="b-top-banners banners-inner">
                  ...
                  <ul class="kwicks kwicks-horizontal">
                     ...
                     <li>	<a style="background-image: url(../assets/template/images/tmp/tmp_slider/newslider/interjer.jpg)" rel="Салон"></a>        </li>

                     <li>         <a style="background-image: url(../assets/template/images/tmp/tmp_slider/newslider/eksterjer1.jpg)" rel="Кузов"></a>        </li>
...
<?php echo "<h1 class='errorForm'>$warning</h1>"; ?>
                         ...
                         <article>
                           ...
                           <p style="text-align: center;"><!--img src="../assets/template/images/ozon.jpg" alt="" width="560" height="449" /--></p>
                           
                           
                         

   <p>Svi moderni automobili su opremljeni sa svime što je potrebno, pa i sa klima uređajem, kako bi boravak i vožnja bili puno ugodniji na vrućini
   i hladnoći. Da bi klima uređaj radio ispravno, zahtijeva povremeno čićenje. Ovaj postupak izvodi se 
     u specijaliziranim servisima i Detailing centrima. </p>
                           ...
                           <ul>
                               ...
                               <li><p>Povjerite čišćenje klime i ventilacije stručnjacima iz „Detailing Star“ centra. Posjedujemo svu profesionalnu opremu za najučinkovitije, sigurno i pravilno čišćenje klime.</p></li>
                           </ul>
                           ...
                           <table class="pricelist-tbl">
                              ...
                              <thead>
                                 ...
                                 <tr>
                                    ...
                                    <th rowspan="2">Antibakterijska obrada klime i ventilacije</th>
                           ...
                           <div class="contact-form order-form">
                              ...
                              <form action="antibakterijska-obrada.php" method="post" id="zakazForm" role="form">
