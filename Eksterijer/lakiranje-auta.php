...
<?php
   ...
   $subject = 'Poruka s detailing Eksterijer > lakiranje auta';
	...
	<br/>
        ...
        <div>
          <table style="width: 400px;" border="1">
              ...
              <tr>
                  <th colspan="2"><h3>Obrazac s lakiranje auta</h3></th>
              </tr>
...
<html class='ie ie7 lt-ie8' lang='en'>
   <![endif]--><!--[if IE 8 ]> 
   <html class='ie ie8 lt-ie8' lang='en'>
      <![endif]--><!--[if IE 9 ]> 
      <html class='ie ie9' lang='en'>
         <![endif]--><!--[if gt IE 9]> <!--><html lang='en'><!-- <![endif]-->
         <head>
            <meta charset="utf-8">
            <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
            <meta name="viewport" content="width=device-width, initial-scale=1">
            <meta name="keywords" content="lakiranje vozila, farbanje vozila, farbanje auta, autolakirnica, bojanje auta" />
            <meta name="description" content="Profesionalno lakiranje elemenata ili cijelog vozila u termo lakirnici">
            <meta name="robots" content="all ">
            <title>Detailing Star | Profesionalna Njega Vozila | Lakiranje auta</title>
          ...
          <link rel="shortcut icon" href="../assets/template/images/favicon.ico">
            ...
            <script src="../assets/template/js/css3-mediaqueries.js"></script>  <![endif]--><!--[if lt IE 9]>  <script src="../assets/template/js/ie9.js"></script>  <![endif]--> 
            <script src="//code.jquery.com/jquery-1.9.1.min.js"></script>  
            <script type="text/javascript">    window.jQuery || document.write("<script src='js/jquery.min.js'>\x3C/script>");
            </script>  
            <script src="http://maps.googleapis.com/maps/api/js?sensor=false"></script>  
            <script src="../assets/template/js/jcarousellite.min.js"></script>  <script src="../assets/template/js/jquery.kwicks.min.js"></script> 
            <script src="../assets/template/js/banner.js"></script>  <script src="../assets/template/js/jquery.fancybox.pack.js"></script> 
            <script src="../assets/template/js/pin.js"></script>  <script src="../assets/template/js/script.js?rand=125"></script> 
             ...
             <header>
               ...
               <div class="b-top-banners banners-inner">
                  <ul class="kwicks kwicks-horizontal">
                     <li>            <a style="background-image: url(../assets/template/images/tmp/tmp_slider/newslider/interjer.jpg)" rel="Interijer"></a>        </li>
                     <li>	 <a style="background-image: url(../assets/template/images/tmp/tmp_slider/newslider/eksterjer1.jpg)" rel="Eksterijer"></a>         </li>
                     <li>          <a style="background-image: url(../assets/template/images/tmp/tmp_slider/newslider/stakla.jpg)" rel="Autostakla"></a>        </li>
                     <li>          <a style="background-image: url(../assets/template/images/tmp/tmp_slider/newslider/eksterjer_felga.jpg)" rel="Felge"></a>        </li>
                  </ul>
               </div>
               <div class="main">
                  <div class="inner">
                     <div class="to-top">          <a>na vrh</a>        </div>
        ...
        <button class="p_close_btn js__p_close">OK</button>
                     ...
                     <div class="content">
                        <ul class="B_crumbBox">
                           ...
                           <li itemscope="itemscope" class="B_lastCrumb B_crumb" itemtype="http://data-vocabulary.org/Breadcrumb" >      <a class="B_crumb" itemprop="url" rel="Салон" href="/services/salon/"><span itemprop="title">Lakiranje vozila</span></a>  </li>
                        ...
                        <div class="wrap-h1">
                           <div class="inner">
                              <h1>          <span>Lakiranje vozila</span>        </h1>
                           </div>
                        </div>
...
<?php echo "<h1 class='errorForm'>$warning</h1>"; ?>
                           ...
                           <p><span style="color:#3C75B3; line-height: 1.5em;"><strong>Восстановительная полировка кузова</strong> </span><span style="line-height: 1.5em;">(или как ее еще часто </span><span style="line-height: 1.5em;">называют абразивная полировка) - одна из составляющих профессионального </span><span style="line-height: 1.5em;">косметического обслуживания автотранспорта, обеспечивающая ему безупречный </span><span style="line-height: 1.5em;">внешний вид.<br /><span style="line-height: 1.5em;"><br />Активная эксплуатация автомобиля связана с постоянным негативным </span><span style="line-height: 1.5em;">воздействием окружающей среды. Осадки, грязь, пыль, копоть от продуктов </span><span style="line-height: 1.5em;">горения, следы от сока растений портят внешний вид и разрушают лакокрасочное </span><span style="line-height: 1.5em;">покрытие кузова машины. Еще больший вред наносят ЛКП некачественные </span><span style="line-height: 1.5em;">автомоечные комплексы, которых, к сожалению, в России большинство. </span><span style="line-height: 1.5em;">Использование ими агрессивных щелочных составов (на первом этапе </span><span style="line-height: 1.5em;">бесконтактной мойки) приводит к разрушению лака на кузове, а механическое </span><span style="line-height: 1.5em;">протирание (завершающий этап "бесконтакта"), мягко говоря, "не первой свежести </span><span style="line-height: 1.5em;">тряпочками" действует на ЛКП как наждачная бумага. После такой мойки кузову </span><span style="line-height: 1.5em;">вашего авто обязательно потребуется полировка царапин, выполнять которую </span><span style="line-height: 1.5em;">нужно только в центре профессионального детейлинга. Здесь вам не просто </span><span style="line-height: 1.5em;">аккуратно выполнят абразивную полировку, максимально сохранив </span><span style="line-height: 1.5em;">лакокрасочный слой, но и защитят кузов от "опасных" автомоек при помощи </span><span style="line-height: 1.5em;">защитных покрытий.<br /></span></span></p>
                           <p style="text-align: center;"><img src="../assets/template/images/abraz.jpg" alt="" /></p>
                           <p><span style="line-height: 1.5em;"><span style="line-height: 1.5em;"><strong><br />Абразивная полировка кузова автомобиля в «Advance </strong></span></span><strong style="line-height: 1.5em;"><span style="line-height: 1.5em;">Star»<br /><br /></span></strong><span style="line-height: 1.5em;">Абразивная полировка автомобиля является трудоемкой процедурой и состоит из </span><span style="line-height: 1.5em;">4 этапов.</span></p>
                           <ul class="b-qlist">
                              <li>
                                 <p><strong>Этап 1. Подготовка к полировке.</strong> <br /><span style="line-height: 1.5em;">Чтобы детально увидеть насколько глубоко повреждено ЛКП, автомобиль </span><span style="line-height: 1.5em;">правильно моется. (Правильной может быть только ДВУХФАЗНАЯ </span><span style="line-height: 1.5em;">технология мойки). Далее при помощи профессиональных световых </span><span style="line-height: 1.5em;">приборов изучается состояние лакокрасочного покрытия кузова, </span><span style="line-height: 1.5em;">маскируются детали из неокрашенного пластика. При помощи автоскраба с </span><span style="line-height: 1.5em;">кузова удаляются окисленный слой ЛКП, инородные вкрапления, </span><span style="line-height: 1.5em;">облипания различного характера - битум, дорожная разметка, смола </span><span style="line-height: 1.5em;">деревьев и прочие загрязнения.<br /><br /></span></p>
                              </li>
                              <li><strong><strong>Этап 2. Абразивная полировка или восстановление.<br /></strong></strong><span style="line-height: 1.5em;">Полировка царапин на автомобиле, а также удаление с ЛКП всевозможных </span><span style="line-height: 1.5em;">рисок, помутнений, окислений и разрушений лака, в том числе возникших в </span><span style="line-height: 1.5em;">результате ультрафиолетового солнечного воздействия, птичьего помета, </span><span style="line-height: 1.5em;">механического воздействия. Выполняется абразивная полировка при </span><span style="line-height: 1.5em;">помощи профессионального оборудования и инструментов, полировальных </span><span style="line-height: 1.5em;">паст и кругов для полировки. Все используемые инструменты и материалы </span><span style="line-height: 1.5em;">- самого высокого качества, произведены в Америке и Европе, </span><span style="line-height: 1.5em;">зарекомендовали себя на мировом рынке как самые эффективные и </span><span style="line-height: 1.5em;">безопасные. Их использование помогает добиться идеального результата </span><span style="line-height: 1.5em;">полировки, не сильно снижая толщину лака.<br /><br /></span></li>
                              <li><strong><strong>Этап 3. Антиголограммная полировка.<br /></strong></strong><span style="line-height: 1.5em;">Этот этап - один из важнейших. Именно в ходе его покрытие доводится до </span><span style="line-height: 1.5em;">зеркального состояния, устраняются микроцарапины (голограммы) </span><span style="line-height: 1.5em;">толщиной 1-3 мкм, которые остаются после полировки более грубой </span><span style="line-height: 1.5em;">полировальной пастой и кругами. На этапе антиголограммной полировки </span><span style="line-height: 1.5em;">лак приобретает максимальный блеск.<br /><br /></span></li>
                              <li><strong><strong>Этап 4. Защитная полировка. <br /></strong></strong><span style="line-height: 1.5em;">Отполированная поверхность кузова - очень уязвима и может легко </span><span style="line-height: 1.5em;">потерять свой сверкающий вид из-за любого механического, химического и </span><span style="line-height: 1.5em;">ультрафиолетового воздействия. Чтобы сохранить воссозданные блеск и </span><span style="line-height: 1.5em;">красоту, рекомендуется завершить процесс абразивной полировки </span><span style="line-height: 1.5em;">обработкой ЛКП <a href="services/kuzov/keramicheskie-pokryitiya/">защитным покрытием</a>. </span></li>
                           </ul>
                           <p>Абразивная полировка позволяет достигнуть отличных <span style="line-height: 1.5em;">результатов:<br /></span><span style="line-height: 1.5em;">- удаления окисленного и разрушенного верхнего слоя лака;<br /></span><span style="line-height: 1.5em;">- устранение незначительных рисок и царапин;<br /></span><span style="line-height: 1.5em;">- возвращения сочности цвета и блеска.<br /></span><strong style="line-height: 1.5em;"><br />Абразивная полировка цена<br /></strong><span style="line-height: 1.5em;">Процесс абразивной полировки занимает от пары часов до нескольких суток (в  </span><span style="line-height: 1.5em;">зависимости от состояния авто). Качественная и безопасная полировка кузова - </span><span style="line-height: 1.5em;">настоящее искусство, которому учатся долгие годы. Ведь толщина лака на </span><span style="line-height: 1.5em;">современных автомобилях тоньше человеческого волоса, и снести его целиком </span><span style="line-height: 1.5em;">проще простого. Именно поэтому доверять столь ответственную "ювелирную" </span><span style="line-height: 1.5em;">работу можно только настоящим мастерам своего дела, которые не просто знают, </span><span style="line-height: 1.5em;">а тонко чувствуют какую выбрать частоту вращения инструмента на каждой </span><span style="line-height: 1.5em;">отдельно взятой части кузова, с каким усилием прикладывать его к поверхности, </span><span style="line-height: 1.5em;">какую пасту на каком лаке можно, а какую нельзя использовать и т.д. Абразивная </span><span style="line-height: 1.5em;">полировка - очень нужная и чрезвычайно ответственная процедура, которая не </span><span style="line-height: 1.5em;">может стоить дешево. Поэтому не экспериментируйте самостоятельно и не </span><span style="line-height: 1.5em;">доверяйте свой автомобиль недорогому автосервису.<br /></span><strong style="line-height: 1.5em;"><br />Гарантии «Advance Star»<br /></strong><span style="line-height: 1.5em;">Если вы хотите долго и с удовольствием ездить в ухоженном автомобиле, </span><span style="line-height: 1.5em;">который даже после нескольких лет эксплуатации будет выглядеть как новый и </span><span style="line-height: 1.5em;">привлекать к себе восхищенные взоры, то вам показана восстановительная </span><span style="line-height: 1.5em;">полировка кузова автомобиля, цена на которую в «Advance Star» самая </span><span style="line-height: 1.5em;">приемлемая. Кроме того, мы гарантируем высокое качество своих работ и </span><span style="line-height: 1.5em;">дорожим своей репутацией Центра профессионального детейлинга! Приезжайте и </span><span style="line-height: 1.5em;">Вы, и удостоверьтесь, что мы - лучшие на российском рынке детейлинга.</span></p>
                           <h3>Стоимость абразивной полировки кузова</h3>
                           <table class="pricelist-tbl">
                              <thead>
                                 <tr>
                                    <th><span style="font-size: 12px; font-weight: normal; line-height: 18px;">Восстановительная полировка кузова</span></th>
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    <td style="text-align: center;">Одна деталь</td>
                                    <td>от 900 руб.</td>
                                    <td>от 900 руб.</td>
                                    <td>от 900 руб.</td>
                                 </tr>
                           ...
                           <div class="contact-form order-form">
                              <form action="lakiranje-auta.php" method="post" id="zakazForm" role="form">
