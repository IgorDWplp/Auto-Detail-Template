...
<?php
   ...
   $subject = 'Poruka s detailing Eksterijer > poliranje vozila';
	...
	<br/>
        ...
        <div>
          <table style="width: 400px;" border="1">
              ...
              <tr>
                  <th colspan="2"><h3>Obrazac s poliranje vozila</h3></th>
              </tr>
   ...
   <html class='ie ie8 lt-ie8' lang='en'>
      ...
      <html class='ie ie9' lang='en'>
         ...
         <head>
            ...
            <meta name="keywords" content="poliranje auta, poliranje vozila, poliranje laka, ogrebotine auta, uklanjanje ogrebotina, nano zaštita, pranje auta" />
            <meta name="description" content="Auto vam je izgubio sjaj te ima toćkica i ogrebotina? Dođite na profesionalno poliranje vašeg automobila sa vrhunskim proizvodima u centar Detailing Star i zaštitite ga nano premazima!">
            <meta name="robots" content="all">
            <title>Detailing Star | Profesionalna Njega Vozila | Zagreb</title>
    ...
    <div class="p_content">
        ...
        <button class="p_close_btn js__p_close">OK</button>
                     ...
                     <div class="content">
                        ...
                        <div class="wrap-h1">
                           <div class="inner">
                              <h1>          <span>Poliranje vozila</span>        </h1>
                           </div>
                        </div>
...
<div class="contact-form order-form">
    ...
    <form action="poliranje-vozila.php" method="post" id="zakazForm" role="form">
