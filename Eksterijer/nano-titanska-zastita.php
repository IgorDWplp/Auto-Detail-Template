...
<?php
   ...
   $subject = 'Poruka s detailing Interijeri > nano titanska zaštita ';
	...
	<br/>
        ...
        <div>
          <table style="width: 400px;" border="1">
              ...
              <tr>
                  <th colspan="2"><h3>Obrazac s nano titanska zaštita </h3></th>
              </tr>
   ...
   <html class='ie ie8 lt-ie8' lang='en'>
      ...
      <html class='ie ie9' lang='en'>
         ...
         <head>
            ...
            <meta name="keywords" content="nano zaštita, detailing, njega vozila, zaštita vozila, poliranje vozila, poliranje auta, nano keramika, titanska zaštita, pranje auta, tekuće staklo" />
            <meta name="description" content="Zaštitite svoj automobil pomoču najmoderne nanotehnologije. Vrhunski zaštitni nano premazi nove generacije: Titanska nano zaštita">
            <meta name="robots" content="all ">
            
            <title>Detailing Star | Profesionalna Njega Vozila | Nano zaštita karoserije</title>
            ...
            <div id="wrapper">
               ...
               <div class="b-top-banners banners-inner">
                  <ul class="kwicks kwicks-horizontal">
                     <li>	<a style="background-image: url(../assets/template/images/tmp/tmp_slider/newslider/interjer.jpg)" rel="Кузов"></a>        </li>
                     <li>            <a style="background-image: url(../assets/template/images/tmp/tmp_slider/newslider/eksterjer1.jpg)" rel="Салон"></a>        </li>
                     <li>          <a style="background-image: url(../assets/template/images/tmp/tmp_slider/newslider/stakla.jpg)" rel="Стекла"></a>        </li>
                     <li>          <a style="background-image: url(../assets/template/images/tmp/tmp_slider/newslider/eksterjer_felga.jpg)" rel="Диски"></a>        </li>
                  </ul>
               </div>
               <div class="main">
                  <div class="inner">
...
<ul class="B_crumbBox">
 ...
 <li itemscope="itemscope" class="B_crumb" itemtype="http://data-vocabulary.org/Breadcrumb">   <a class="B_crumb" itemprop="url" rel="Услуги" href="../Usluge.html">
                        ...
                        <article>
                           ...
                           <p ><span style="line-height: 1.5em;"><strong>Nano titanska zaštita Kraytex Mega 10</strong></span> je unikatni zaštitni premaz, koji maksimalno štiti lak Vašeg automobila.</p>
                            ...
                            <p class="Padding_text_naslov">
                                ...
                                Krytex 7H+ zbog postizanja dodatnih željenih svojstva. To znači da tvrdoča i debljina premaza može biti povečena 
                                dodavanjem više slojeva Krytex premaza, što će povećati njegovu otpornost na ogrebotine, mehanička oštećenja i dodatno povećati 
                                 hidrofobni efekt.
                            </p>
                ...
                <p>  
                   ...
                   <h3>Cijena nanošenja nano titanske zaštite Krytex Mega 10</h3>
                     <p class="Padding_text_naslov">
                         ...
                         Cijena nanošenja nano titanske zaštite Krytex Mega 10 ovisi o vrsti vozila i stanja laka. Iskazana cijena usluge ne uključuje poliranje vozila, a uključuje nanošenje 2 zaštitna sloja Mega 10 premaza, što je dovoljno za vrhunsku dogotrajnu zaštitu, te zaštitu plastičnih dijelova eksterijera nano premazom.
Zbog postizanja još bolje čvrstoće i hidrofobnog svojstva, moguče je nanošenje dopunskih slojeva Krytex Mega 10 ili drugih Krytex premaza. 
                     </p>
                           ...
                           <div class="contact-form order-form">
                              <form action="nano-titanska-zastita.php" method="post" id="zakazForm" role="form">
...
<?php echo $result; ?>
                           ...
                           <script src="../assets/template/js/myForm.js"></script>                        <br/>   	<!--div class="form-new">		<span class="form-zag"><span>Записаться на услугу - <i>Восстановительная полировка кузова</i></span></span>		<div class="clear"></div>		<div class="overlay"></div>		<div class="msg_wrap">                <div class="close_msg">x</div>            	<div class="window">    				<div class="insText">    					<p><strong>Ваше сообщение отправлено.</strong>Мы свяжемся с вами в ближайшее время!</p>    				</div>    	   		</div>        </div>	      <div id="myform-wrap">              <div id="myform">           <form class="lightform" action="">               <div class="inps">			<label for="name" style="margin: 6px 24px 0 160px;">Ваше имя:*</label>           <input class="inp" name="name" id="name" type="text" required />		   <div class="clear marclear"></div>		   <label style="margin: 6px 24px 0 170px;" for="phone">Телефон:*</label>           <input class="inp" name="phone" id="phone" type="tel" pattern="[\d+-]{5,}" />		   <div class="clear marclear"></div>		   <label style="margin: 6px 31px 0 190px;" for="email">E-mail:</label>           <input class="inp" name="email" id="email" type="email"/>		   <div class="clear marclear"></div>            <input type="hidden" name="type" value="raschet" />            <input type="hidden" name="pagetitle" value="Восстановительная полировка кузова" />  			<input type="hidden" name="url" value="http://www.advancestar.ru/services/kuzov/abrazivnaya-polirovka/" />           </div>           <div class="comment">		   <label style="margin: 6px 31px 0 130px;" for="comment">Комментарий:</label>           <textarea class="inp" name="comment" id="comment" rows="10" ></textarea>		   <div class="clear"></div>		   <p class="att">*Обязательное поле для заполнения</p>		   <div class="clear marclear"></div>           <input class="btn-send" type="submit" value="Отправить" />		   </div>           </form>           </div>       </div></div--><!--div class="mob-frm">	<span class="form-zag-m"><span>Заказать услугу -<br /> <i>Восстановительная полировка кузова</i></span></span>	<span class="phn">+7 495 991-39-69</span></div>		</article>        </div>      </div>	      </div>  </div-->
                           <div class="mob-frm" style="display: none;"><span class="form-zag-m"><span> -<br /> <i></i></span></span><span class="phn"></span></div>
                        </article>
                     </div>
                  </div>
               </div>
