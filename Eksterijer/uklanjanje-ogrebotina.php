...
<?php
   ...
   $subject = 'Poruka s detailing Eksterijer > uklanjane ogrebotina';
	...
	<br/>
        ...
        <div>
          <table style="width: 400px;" border="1">
              ...
              <tr>
                  <th colspan="2"><h3>Obrazac s uklanjane ogrebotina</h3></th>
              </tr>
   ...
   <html class='ie ie8 lt-ie8' lang='en'>
      ...
      <html class='ie ie9' lang='en'>
         ...
         <head>
            ...
            <meta name="description" content="Saniranje dubokih ogrebotina laka na autu bez lakiranje cijelog elementa. Poliranje i lakiranje vozila">
            <meta name="robots" content="all ">
            <title>Detailing Star | Profesionalna Njega Vozila | Uklanjnje ogrebotina</title>
    ...
    <div class="p_content">
        ...
        <button class="p_close_btn js__p_close">OK</button>
                     ...
                     <div class="content">
                        ...
                        <div class="wrap-h1">
                           <div class="inner">
                              <h1>          <span>Uklanjanje ogrebotina</span>        </h1>
                           </div>
                        </div>
...
<?php echo "<h1 class='errorForm'>$warning</h1>"; ?>
                       ...
                       <article style="display: none;">
                           ...
                           <div class="contact-form order-form">
                               <form action="uklanjanje-ogrebotina.php" method="post" id="zakazForm" role="form">
