...
<?php
   ...
   $subject = 'Poruka s detailing Eksterijer> polimerna zaštita mega quick';
	...
	<br/>
        ...
        <div>
          <table style="width: 400px;" border="1">
              ...
              <tr>
                  <th colspan="2"><h3>Obrazac s polimerna zaštita mega quick</h3></th>
              </tr>
   ...
   <html class='ie ie8 lt-ie8' lang='en'>
      ...
      <html class='ie ie9' lang='en'>
         ...
         <head>
            ...
            <meta name="description" content="Zaštitite svoj automobil pomoču najmoderne nanotehnologije. Vrhunski zaštitni polimerni nano premaz nove generacije Mega Quick Krytex">
            <meta name="robots" content="all ">
            <title>Detailing Star | Profesionalna Njega Vozila | Nano polimerni premazi</title>
...
<div class="popup js__popup js__slide_top">
    ...
    <div class="p_content">
        ...
        <button class="p_close_btn js__p_close">OK</button>
            ...
            <div class="wrap-h1">
               <div class="inner">
                  <h1>          <span>Nano polimerni premazi Mega Quick Krytex</span>        </h1>
               </div>
            </div>
...
<div class="contact-form order-form">
    ...
    <form action="polimerna-zastita-mega-quick.php" method="post" id="zakazForm" role="form">
