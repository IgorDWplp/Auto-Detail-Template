...
<?php
   ...
   $subject = 'Poruka s detailing Eksterijer > zaštita folijom suntek';
	...
	<br/>
        ...
        <div>
          <table style="width: 400px;" border="1">
              ...
              <tr>
                  <th colspan="2"><h3>Obrazac s zaštita folijom suntek</h3></th>
              </tr>
   ...
   <html class='ie ie8 lt-ie8' lang='en'>
      ...
      <html class='ie ie9' lang='en'>
         ...
         <head>
            ...
            <meta name="keywords" content="folija SUNTEK, zaštitna folija, anti termalna folija, auto detailing, detailing, njega vozila, zaštita vozila, poliranje vozila, poliranje auta" />
            <meta name="description" content="Maksimalna zaštita vozila folijom premium klase Suntek. Profesionalna ugradnja, dugotrajno rješenje">
            <meta name="robots" content="all ">
            <title>Detailing Star | Profesionalna Njega Vozila | Zaštita folijom Suntek</title>
                     ...
                     <div class="content">
                        <ul class="B_crumbBox">
                           ...
                           <li itemscope="itemscope" class="B_lastCrumb B_crumb" itemtype="http://data-vocabulary.org/Breadcrumb" >    
                               <a class="B_crumb" itemprop="url" rel="Салон" href="/services/salon/"><span itemprop="title">Zaštita folijom Suntek</span></a>  </li>
                        ...
                        <div class="wrap-h1">
                           <div class="inner">
                              <h1>          <span>Zaštita folijom SunTek</span>        </h1>
                           </div>
                        </div>
...
<?php echo "<h1 class='errorForm'>$warning</h1>"; ?>
                       ...
                       <article style="display: none;">
                           ...
                           <div class="contact-form order-form">
                              <form action="zastita-folijom-SunTek.php" method="post" id="zakazForm" role="form">
