...
<?php
   ...
   $subject = 'Poruka s detailing Felge > Nano zaštita felga';
	...
	<br/>
        ...
        <div>
          <table style="width: 400px;" border="1">
              ...
              <tr>
                  <th colspan="2"><h3>Obrazac s Nano zaštita felga</h3></th>
              </tr>
...
<head><meta charset="utf-8">
  ...
  <meta name="keywords" content="zaštitia felga, kemijsko čišćenje, autopraonica, nano zaštita, auto detailing, detailing, njega vozila, zaštita vozila, poliranje vozila, poliranje auta, pranje auta, čišćenje felga" />
  <meta name="description" content="Kemijsko čišćenje i nano zaštita felga. Kemijsko čišćenje i zaštita nano tehnologijom tkanine, kože i plastike interijera auta. Radimo sa najekskluzivnim i najnaprednim sredstvama Krytex">
  <meta name="robots" content="all ">
  <title>Detailing Star | Profesionalna Njega Vozila | Nano zaštita felga</title>
    ...
    <header>
 	...
 	<div class="b-top-banners banners-inner">
      <ul class="kwicks kwicks-horizontal">
		<li>
	<a style="background-image: url(../assets/template/images/tmp/tmp_slider/newslider/interjer.jpg)" rel="Диски"></a>
        </li>
        <li> 
        ...
        <li>
          <a style="background-image: url(../assets/template/images/tmp/tmp_slider/newslider/eksterjer_felga.jpg)" rel="Салон"></a>
        </li>
      </ul>
    </div>
 ...
 <ul class="B_crumbBox">
  ...
  <li itemscope="itemscope" class="B_crumb" itemtype="http://data-vocabulary.org/Breadcrumb">
    ...
    <li itemscope="itemscope" class="B_lastCrumb B_crumb" itemtype="http://data-vocabulary.org/Breadcrumb" >
      <a class="B_crumb" itemprop="url" rel="Салон" href=""><span itemprop="title">Nano zaštita felga</span></a>
  </li>
...
Jedan od glavnih problema sa naplatcima je metalna prašina iz kočionih pločica i prljavština kojoj su konstantno izložni.

</p>					   
					   
<p class="Padding_text_naslov">
Od ovih utjecaja naplatci znaju požutjeti, oksidirati i korodirati.
</p>


<p class="Padding_text_naslov">
Nano zaštitni premaz Krytex Rims, štiti naplatke od svih vanjskih utjecaja, olakšava čišćenje i pranje, sprečava sitne ogrebotine i daje dugotrajan sjaj.
</p>


<p><strong><span style="color: #3C75B3;">Prednosti premaza Krytex Rims:</strong></span></p>


<ul class="PaddingText_ul">
<li><p>Smanjuje primanje prljavštine i prašine kočnice na naplatke;</p></li>
<li><p>Olakšava  čišćenje;</p></li>
<li><p>Štiti od oksidiranja i korozije</p></li>
<li><p>Sprječava sitne ogrebotine</p></li>
</ul>
...
<div class="contact-form order-form">
    ...
    <form action="nano-zastita-felga.php" method="post" id="zakazForm" role="form">
