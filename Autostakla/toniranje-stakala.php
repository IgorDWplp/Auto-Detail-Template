...
<?php
   ...
   $subject = 'Poruka s detailing Autostakala > toniranje stakala';
	...
	<br/>
        ...
        <div>
          <table style="width: 400px;" border="1">
              ...
              <tr>
                  <th colspan="2"><h3>Obrazac s toniranje stakala</h3></th>
              </tr>
...
<div class="contact-form order-form">
    ...
    <form action="toniranje-stakala.php" method="post" id="zakazForm" role="form">
