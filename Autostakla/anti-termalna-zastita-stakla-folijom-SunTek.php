...
<?php
   ...
   $subject = 'Poruka s detailing Autostakala > anti termalna zaštita stakla folijom SunTek';
	...
	<br/>
        ...
        <div>
          <table style="width: 400px;" border="1">
              ...
              <tr>
                  <th colspan="2"><h3>Obrazac s anti termalna zaštita stakla folijom SunTek</h3></th>
              </tr>
...
<head><meta charset="utf-8">
  ...
  <meta name="description" content="Anti termalna zaštita autostakla, zaštita farova od oštećenja folijom, poliranje farova automobila, poliranje vozila, zaštitni nano premazi">
  <meta name="robots" content="all ">
  <title>Detailing Star | Profesionalna Njega Vozila | Anti termalna zaštita stakla</title>
 ...
 <ul class="B_crumbBox">
  ...
  <li itemscope="itemscope" class="B_crumb" itemtype="http://data-vocabulary.org/Breadcrumb">
    ...
    <li itemscope="itemscope" class="B_lastCrumb B_crumb" itemtype="http://data-vocabulary.org/Breadcrumb" >
      <a class="B_crumb" itemprop="url" rel="Салон" href="/services/salon/"><span itemprop="title">Anti termalna zaštita stakla folijom SunTek</span></a>
  </li>
...
<div class="wrap-h1">
 <div class="inner">
        <h1>
          <span>Anti termalna zaštita stakla folijom SunTek</span>
        </h1>
 </div>
</div>
...
<?php echo "<h1 class='errorForm'>$warning</h1>"; ?>
			...
			<p style="text-align: center;"><img src="../assets/template/images/atern.jpg" alt="" width="560" height="441" /></p>
<p>В связи с ужесточением норм ГИБДД по допустимой тонировке стекол появился устойчивый спрос на так называемую «тонировку по ГОСТу». <strong><span style="color: #7030a0;">Атермальная тонировка</span></strong> совершенно не влияет на светопроницаемость стекла, зато отлично защищает от солнечного излучения.<br /><br />Тонирование атермальными пленками (пленками теплового отклонения) от ведущих производителей 3M, Llumar, SunTek является оптимальным решением. Его основное достоинство – обеспечение комфорта в салоне наряду с соблюдением требований автомобильного законодательства.<br /><br />Данные пленки обеспечивают до 95% светопропускания, что полностью соответствует нормативам. При этом они практически целиком (на 99%) блокируют ультрафиолетовое излучение и защищают от инфракрасных лучей (на 93%), то есть препятствуют сильному нагреву салона автомобиля.<br /><br /><strong>Преимущества <span style="color: #7030a0;">атермального тонирования</span>:</strong></p>
<ul>
<li><span style="line-height: 1.5em;">полностью соответствует требованиям законодательства;</span></li>
<li><span style="line-height: 1.5em;">максимально защищает салон от нагрева;</span></li>
<li><span style="line-height: 1.5em;">обеспечивает комфорт водителя и пассажиров;</span></li>
<li><span style="line-height: 1.5em;">повышает уровень пассивной безопасности;</span></li>
<li><span style="line-height: 1.5em;">допустимо для лобовых стекол.<br /></span></li>
</ul>
<h3>Стоимость атермального тонирования стекол</h3>
<table class="pricelist-tbl">
<thead>
<tr><th>Атермальное тонирование</th><th>C класс</th><th>E класс</th><th>S класс и внедорожники</th></tr>
</thead>
<tbody>
<tr>
...
<div class="contact-form order-form">
    ...
    <form action="anti-termalna-zastita-stakla-folijom-SunTek.php" method="post" id="zakazForm" role="form">
