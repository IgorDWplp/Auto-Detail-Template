...
<?php
   ...
   $subject = 'Poruka s detailing Autostakala > nano zaštita stakala';
	...
	<br/>
        ...
        <div>
          <table style="width: 400px;" border="1">
              ...
              <tr>
                  <th colspan="2"><h3>Obrazac s nano zaštita stakala</h3></th>
              </tr>
...
<head><meta charset="utf-8">
  ...
  <meta name="keywords" content="zaštita stakala, carglass, popravak stakla auta, premaz za autostakla, nano zaštita, detailing, njega vozila, zaštita vozila, poliranje vozila, poliranje auta, nano keramika, titanska zaštita, pranje auta, tekuće staklo" />
  <meta name="description" content="Zaštitite svoj automobil pomoču najmoderne nanotehnologije. Vrhunski zaštitni nano premazi nove generacije. Nano zaštita stakala automobila">
  <meta name="robots" content="all ">
  <title>Detailing Star | Profesionalna Njega Vozila | Nano zaštita stakala </title>
 ...
 <ul class="B_crumbBox">
  ...
  <li itemscope="itemscope" class="B_crumb" itemtype="http://data-vocabulary.org/Breadcrumb">
    ...
    <li itemscope="itemscope" class="B_lastCrumb B_crumb" itemtype="http://data-vocabulary.org/Breadcrumb" >
      <a class="B_crumb B_lastCrumb" itemprop="url" rel="Салон" href=""><span itemprop="title">Nano zaštita stakala </span></a>
  </li>
...
<div class="wrap-h1">
 <div class="inner">
        <h1>
          <span>Nano zaštita stakala </span>
        </h1>
 </div>
</div>
...
<article>
<p>
<strong><span style="color: #3C75B3;">Hidrofobna zaštita Krytex Glass</strong></span> osigurava udobnu vožnju čak i u najtežim vremenskim uvjetima, 
smanjuje stres i umor očiju, posebno noću.
</p>



<strong><span style="color: #3C75B3;">Krytex Glass omogućava lako skidanje leda zimi, a kukaca ljeti. </strong></span>


<p class="">
Za razliku od jeftinih hidrofobnih (anti rain) premaza, Krytex Glass ima unikatnu formulu 
zbog koje ima izuzetno prijanjanje na podlogu, što rezultira da efekt zaštite traje nekoliko puta 
dulje od običnih sredstava. Uz to štiti staklo od sitnih ogrebotina i manjih oštećenja.
</p>   
   


<p><strong><span style="color: #3C75B3;">Prednosti Krytex Glass premaza:</strong></span></p>
<ul class="PaddingText_ul">
<li><p>Jaka hidrofobna svojstva;</p></li>
<li><p>Dugoročni učinci;</p></li>
<li><p>Zaštita vjetrobranskog stakal od ogrebotina i sitnih oštećenja;</p></li>
<li><p>Sigurna vožnja u svim vremenskim uvjetima.</p></li>
</ul>
        ...
        <table class="pricelist-tbl">
                              <thead>
                                 <tr>
                                    <th rowspan="2">Nano zaštita vetrobranskog stakla</th>
                                    <th>Golf  Class </th>
                                    <th>C Class </th>
                                    <th>E Class </th>
...
<br/>
                              ...
                              <thead>
                                 <tr>
                                    <th rowspan="2" style="width: 204px;">Nano zaštita svih stakala </th>
                                    <th>Golf  Class </th>
                                    <th>C Class </th>
                                    <th>E Class </th>
                                    <th>S class i terenci</th>
...
<div class="contact-form order-form">
    ...
    <form action="nano-zastita-stakala.php" method="post" id="zakazForm" role="form">
